...
class Assistant:
    ...
    def prompt(self, prompt_text: str) -> str:
        text = self.client.chat.completions.create(
            model="gpt-5-nano",
            messages=[
                {"role": "system", "content": f"You are a helpful expert to the user and your domain of knowledge is limited to {self.domain}. Do not answer queries outside of your domain of knowledge."},
